 ...
 */
 ...
 byte kpRowPins[4] = { 14, 27, 26, 25 };   // keypad pins 1–4
 byte kpColPins[4] = { 33, 32, 4, 2 };     // keypad pins 5–8
 ...
 void setup() {
   ...
   // GPIO 25 is also DAC_CHANNEL_1; disable DAC so it works as normal digital I/O for the keypad.
